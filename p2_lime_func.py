...
def the_lime (items_no,predictions_all,labels,data,info,model3,verbose = False,show=False, save = True, base_path='C:\\Users\\User\\'):
    ...
    for item in items_no:
        ...
        explanation = explainer.explain_instance(data[item].astype('double'), model3.predict,  
                                                 top_labels=2, hide_color=0, num_samples=1000, num_features = 100000,segmentation_fn = segmentation_fn)
        ...
        temp_1, mask_1 = explanation.get_image_and_mask(explanation.top_labels[0], positive_only=True,negative_only = False, num_features=1, hide_rest=False)
